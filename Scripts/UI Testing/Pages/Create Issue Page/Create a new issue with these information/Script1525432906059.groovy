...
WebUI.verifyElementText(findTestObject('UI Test Objects/Pages/Create Issue Page/elTitle'), 'Import issues\nCreate issue')
...
WebUI.click(findTestObject('UI Test Objects/Pages/Master Page/elFlag'))
